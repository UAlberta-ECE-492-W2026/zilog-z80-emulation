...
module controller_output_tb();
    ...
    initial begin: test_definition
        ...
        testvectors.push_back(cons_test("ld_reg_a_imm_1", uop::ld_reg_a_imm_1));
        testvectors.push_back(cons_test("ld_reg_b_imm_1", uop::ld_reg_b_imm_1));
        testvectors.push_back(cons_test("buff_addr_reg_a", uop::buff_addr_reg_a));
        testvectors.push_back(cons_test("write_reg_bH", uop::write_reg_bH));
        testvectors.push_back(cons_test("write_reg_bL", uop::write_reg_bL));
        testvectors.push_back(cons_test("write_mrbuffL_p1", uop::write_mrbuffL_p1));
        testvectors.push_back(cons_test("read_mrbuff_reg_b_imm_0", uop::read_mrbuff_reg_b_imm_0));
        testvectors.push_back(cons_test("read16_reg_a_reg_b_imm_0", uop::read16_reg_a_reg_b_imm_0));
        testvectors.push_back(cons_test("read_mbuff_mrbuff", uop::read_mbuff_mrbuff));
        testvectors.push_back(cons_test("exx", uop::exx));
