...
#ifndef VERILATED_VAXI_WRAPPER_H_
#define VERILATED_VAXI_WRAPPER_H_  // guard

#include "verilated.h"

class Vaxi_wrapper__Syms;
class Vaxi_wrapper___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vaxi_wrapper VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    Vaxi_wrapper__Syms* const vlSymsp;
  ...
  public:
    ...
    Vaxi_wrapper___024root* const rootp;
    ...
    explicit Vaxi_wrapper(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vaxi_wrapper(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vaxi_wrapper();
  private:
    VL_UNCOPYABLE(Vaxi_wrapper);  ///< Copying not allowed
