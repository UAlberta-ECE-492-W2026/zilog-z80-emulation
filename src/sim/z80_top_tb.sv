...
module z80_top_tb #() ();
    ...
    initial begin
        ...
        testvectors.push_back(cons_test(32'h31100000, 16'h0000, 16'h0000, 16'h0000, 16'h0010, 16'h0004, 64'h0000000000000000)); // ld        sp,$0010
        testvectors.push_back(cons_test(32'hcd371300, 16'h0000, 16'h0000, 16'h0000, 16'h000e, 16'h1337, 64'h0000000000003713)); // CALL      1337
        testvectors.push_back(cons_reset());
