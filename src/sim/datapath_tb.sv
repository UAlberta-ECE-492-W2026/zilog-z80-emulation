...
module datapath_tb();
    ...
    //  testvectors.push_back('{0,     0,         0,               0,          0,            ALU_NOP,        6'b000000,    NONE,      NONE,      NONE,      0,        0,      F_NOP,EXX_NOP,A_MUX_NOP,       B_MUX_NOP,                WB_MUX_NOP,              8'h00,     16'h0000, 0,                 6'b000000,  6'b000000,               16'h0000}); // blank template
        ...
        testvectors.push_back('{0,     0,         0,               0,          0,            ALU_NOP       , 6'b000000,    NONE     , NONE     , NONE     , 0,        1,      F_SCF,EXX_NOP,A_MUX_NOP       ,B_MUX_NOP                ,WB_MUX_NOP             , 8'h00,     16'h0000, 0,                 6'b000001,  6'b000000,               16'h0000});  // SCF flag op
        ...
        testvectors.push_back('{0,     0,         0,               0,          0,            ALU_NOP       , 6'b000000,    NONE     , NONE     , NONE     , 0,        1,      F_CCF,EXX_NOP,A_MUX_NOP       ,B_MUX_NOP                ,WB_MUX_NOP             , 8'h00,     16'h0000, 0,                 6'b000000,  6'b000000,               16'h0000});  // CCF flag op
        testvectors.push_back('{0,     0,         0,               0,          0,            ALU_NOP       , 6'b000000,    NONE     , NONE     , NONE     , 0,        1,      F_CCF,EXX_NOP,A_MUX_NOP       ,B_MUX_NOP                ,WB_MUX_NOP             , 8'h00,     16'h0000, 0,                 6'b000001,  6'b000000,               16'h0000});  // CCF flag op (again)
